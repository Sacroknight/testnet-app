...
class PermissionPreferences private constructor() {
    ...
    object PermissionPreferencesKeys {
        val DONT_ASK_AGAIN_LOCATION_PERMISSION = booleanPreferencesKey("dont_ask_again_location_permission")
        val ASK_OPEN_PERMISSION = booleanPreferencesKey("ask_open_permission")
        val DONT_ASK_AGAIN_PHONE_PERMISSION = booleanPreferencesKey("dont_ask_again_phone_permission")
    }

    suspend fun savePermissionPreference(context: Context, key: Preferences.Key<Boolean>, value: Boolean) {
